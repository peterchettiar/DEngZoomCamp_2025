...
[Google's Looker Studio (formerly Google Data Studio)](https://lookerstudio.google.com/navigation/reporting) is an online tool for converting data into ***reports*** and ***dashboards***.

Firstly, we will create a ***Data Source***. Looker Studio supports multiple sources including BigQuery. 

![image](https://github.com/user-attachments/assets/bdf572b1-9b99-4339-a2ca-2770421be57c)

You will notice that Looker Studio has a lot of connectors to variouse databases either managed by google or their partners.

![image](https://github.com/user-attachments/assets/5bfdcbe7-941f-42e3-82ab-7ff573a5e68a)

After authorizing Looker Studio to access BigQuery, we will be able to select our project and datasets. We will connect to our `dbt_production.fact_trips` schema.

![image](https://github.com/user-attachments/assets/2e0a0b64-100d-49b5-8c40-185448704474)
...
![image](https://github.com/user-attachments/assets/81e39ea2-80e6-40ec-8ace-644437cda181)

> [!NOTE]
> Default aggregation assignment when creating a data source on Looker Studio is essential for when summarising reports. Aggregation is important as it impacts how data is visualized in tables, charts, and scorecards.

> The default aggregation was changed for some fields in the table, and this is populated automatically. Hence, it is wise to have a look through before moving to the next section. For example, `dropoff_locationid`, `vendorid` and `payment_type` have default aggregation as `SUM` as their data type are `Number` but in reality they are categories. 
...
![image](https://github.com/user-attachments/assets/0ea4eeb8-0df1-452a-9bd4-7fcd496e8d44)
...
![image](https://github.com/user-attachments/assets/b217ebc5-0012-41e1-ad53-2a698f396d1a)
