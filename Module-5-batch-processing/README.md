...
> An example of a shuffle process for a `join()` as well as a visual explanation of the workings of the `sort-merge` algorithm can be found [here](https://www.youtube.com/watch?v=vswrfVkP10Y).
